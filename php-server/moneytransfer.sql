...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 23, 2020 at 06:52 AM
...
CREATE TABLE `receive` (
  `id` int(10) NOT NULL,
  `agent_users_id` int(10) DEFAULT NULL,
  `send_id` int(10) DEFAULT NULL,
  `subject` varchar(127) DEFAULT NULL,
  `note` text,
  `phone_no` varchar(20) DEFAULT NULL,
  `amount` decimal(10,2) DEFAULT NULL,
  `status` enum('pending','completed','cancel') DEFAULT NULL,
...
INSERT INTO `receive` (`id`, `agent_users_id`, `send_id`, `subject`, `note`, `phone_no`, `amount`, `status`, `created_at`, `updated_at`) VALUES
(3, 9, 2, 'deliver', 'deliver', '77777', '700.00', 'completed', '2020-07-22', '2020-07-22'),
(4, 9, 1, 'deliver', 'deliver', '68454444', '100.00', 'completed', '2020-07-22', '2020-07-22');
...
CREATE TABLE `send` (
  ...
  `phone_no` varchar(20) DEFAULT NULL,
  `amount` decimal(10,2) DEFAULT NULL,
  `assigned_users_id` int(10) DEFAULT NULL,
  `status` enum('pending','assigned','completed','refund') DEFAULT NULL,
  `created_at` date DEFAULT NULL,
  `updated_at` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `send` (`id`, `agent_users_id`, `subject`, `note`, `phone_no`, `amount`, `assigned_users_id`, `status`, `created_at`, `updated_at`) VALUES
(1, 9, 'send', 'send', '68454444', '100.00', 9, 'completed', '2020-07-22', '2020-07-22'),
(2, 9, 'send', 'send', '77777', '700.00', 9, 'completed', '2020-07-22', '2020-07-22');
...
INSERT INTO `transactions` (`id`, `users_id`, `subject`, `note`, `debit`, `credit`, `created_at`, `updated_at`) VALUES
(1, 9, 'xx', 'xx', '0.00', '1000.00', '2020-07-22', NULL),
(2, 9, 'trnsaction of 1', 'trnsaction of 1', '100.00', '0.00', '2020-07-22', '0000-00-00'),
(3, 9, 'fee', 'fee', '100.00', '0.00', '2020-07-22', '0000-00-00'),
(4, 9, 'trnsaction of 2', 'trnsaction of 2', '700.00', '0.00', '2020-07-22', '0000-00-00'),
(5, 9, 'fee', 'fee', '100.00', '0.00', '2020-07-22', '0000-00-00'),
(8, 9, 'deliver of 1', 'deliver of 1', '0.00', '700.00', '2020-07-22', '0000-00-00'),
(9, 9, 'deliver of 1', 'deliver of 1', '0.00', '100.00', '2020-07-22', '0000-00-00');
...
(10, 'aa@aa.com', 'aa', '', 'ABC', 'DEF', NULL, '', '2020-07-21', '', '', '', '', '', '232', '2020-07-21 14:09:51', NULL, 'staff', 'active');
