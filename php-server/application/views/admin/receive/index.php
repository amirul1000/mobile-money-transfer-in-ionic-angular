...
<div>
	<div class="float_left padding_10">
		<a href="<?php echo site_url('admin/receive/save'); ?>"
			class="btn btn-success">Add</a>
	</div>
	<div class="float_left padding_10">
		<i class="fa fa-download"></i> Export <select name="xeport_type"
			class="select"
			onChange="window.location='<?php echo site_url('admin/receive/export'); ?>/'+this.value">
	...
	<div class="float_right padding_10">
		<ul class="left-side-navbar d-flex align-items-center">
			<li class="hide-phone app-search mr-15">
                <?php echo form_open_multipart('admin/receive/search/',array("class"=>"form-horizontal")); ?>
...
<table class="table table-striped table-bordered">
    ...
    ?>
		...
		<td><a
			href="<?php echo site_url('admin/receive/details/'.$c['id']); ?>"
			class="action-icon"> <i class="zmdi zmdi-eye"></i></a> <a
			href="<?php echo site_url('admin/receive/save/'.$c['id']); ?>"
			class="action-icon"> <i class="zmdi zmdi-edit"></i></a> <a
			href="<?php echo site_url('admin/receive/remove/'.$c['id']); ?>"
