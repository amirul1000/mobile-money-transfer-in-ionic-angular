...
<nav>
	<ul class="sidebar-menu" data-widget="tree">
		...
		<li <?php if($this->router->fetch_class()=="receive"){?>
			class="active" <?php }?>><a
			href="<?php echo site_url('admin/receive/index'); ?>"><i
				class="icon_table"></i>Receive</a></li>
		<li <?php if($this->router->fetch_class()=="send"){?> class="active"
			<?php }?>><a href="<?php echo site_url('admin/send/index'); ?>"><i
				class="icon_table"></i>Send</a></li>
		<li <?php if($this->router->fetch_class()=="transactions"){?>
			class="active" <?php }?>><a
			href="<?php echo site_url('admin/transactions/index'); ?>"><i
				class="icon_table"></i>Transactions</a></li>
